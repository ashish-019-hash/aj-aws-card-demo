...
🔴 CRITICAL: Required Sections for Every Job
...
### Step Analysis
**Mandatory Completeness Requirements
- 🔴 CRITICAL: collect details of all step details
...
| STEP020   | IDCAMS   | Utility      | Define VSAM cluster for customer data | IF STEP010.RC ≤ 8 | DEFINE CLUSTER  |
...
### DD Name Analysis
**Mandatory Completeness Requirements
- 🔴 CRITICAL: collect details of all DD names from all steps.
